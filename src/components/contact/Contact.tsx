    ...
    import { isSubmittedInSession, updateSessionStorage } from "../../utils/sessionStorage";
import { useTranslation } from "react-i18next";
    ...
    export default function Contact() {
        ...
        const [isSubmitted, setIsSubmitted] = useState(() => isSubmittedInSession);
                ...
                <div className="bg-white lg:rounded-2xl dark:bg-[#111111]">
                    ...
                    <div className="mx-4 md:mx-[60px] p-4 md:p-16 dark:border-[#212425] dark:border-2 bg-color-810 rounded-xl dark:bg-[#111111] mb-[30px] md:mb-[60px]">
                        ...
                        <form onSubmit={handleSubmit} method="POST">
                            ...
                            value={isSubmitting ? `${t('sending')}` :  isSubmitted ? `${t('submitted')}` : `${t("submit")}`}
                            />
